...
assert_equal(config.GATEWAY_CONFIG_FIELDS.battery_prewake_ms, nil, "gateway config should exclude fixed battery prewake")
...
assert_equal(config.RUNTIME_MUTABLE_FIELDS.battery_prewake_ms, nil, "battery prewake should no longer be mutable")
assert_equal(config.RUNTIME_DEFAULTS.battery_prewake_ms, nil, "battery prewake should no longer be runtime config")
